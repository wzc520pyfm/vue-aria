...
export const themeColorsLight: ThemeColors = {
  ...
  default: {
    ...common.zinc,
    foreground: mycolor(common.zinc[300]).readableColor(),
    DEFAULT: common.zinc[300],
  },
  primary: {
    ...common.blue,
    foreground: mycolor(common.blue[500]).readableColor(),
    DEFAULT: common.blue[500],
  },
  secondary: {
    ...common.purple,
    foreground: mycolor(common.purple[500]).readableColor(),
    DEFAULT: common.purple[500],
  },
  success: {
    ...common.green,
    foreground: mycolor(common.green[500]).readableColor(),
    DEFAULT: common.green[500],
  },
  warning: {
    ...common.yellow,
    foreground: mycolor(common.yellow[500]).readableColor(),
...
export const themeColorsDark: ThemeColors = {
  ...
  default: {
    ...swapColorValues(common.zinc),
    foreground: mycolor(common.zinc[700]).readableColor(),
    DEFAULT: common.zinc[700],
  },
  primary: {
  ...
  secondary: {
    ...
    foreground: mycolor(common.purple[400]).readableColor(),
